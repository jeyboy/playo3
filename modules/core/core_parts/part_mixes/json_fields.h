...
//    const QString JSON_TYPE_IS_REMOTE                   = QStringLiteral("1");
    ...
    const QString JSON_TYPE_CONTAINER_CHILDS            = QStringLiteral("c");
    ...
    const QString JSON_TYPE_ITEM_STATE                  = QStringLiteral("i");
    ...
    const QString JSON_TYPE_DATA_SUB_TYPE               = QStringLiteral("w");
    ...
    const QString JSON_TAB_SETTINGS                     = QStringLiteral("ts");
    const QString JSON_TAB_NAME                         = QStringLiteral("tn");
}
