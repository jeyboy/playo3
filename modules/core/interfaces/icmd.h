...
namespace Core {
    ...
    public:
        enum ICmdMethods {
            ...
            cmd_mtd_video_by_user_history,
            cmd_mtd_video_by_video_channel,
...
//                case cmd_mtd_stream_configuration: return streamConfiguration(params);
        ...
        virtual QJsonValue videoInfo(const QUrlQuery & /*args*/) { return QJsonObject(); }
        ...
        virtual QJsonValue videoByUserHistory(const QUrlQuery & /*args*/) { return QJsonObject(); }
        virtual QJsonValue videoByVideoChannel(const QUrlQuery & /*args*/) { return QJsonObject(); }
