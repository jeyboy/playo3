...
namespace Core {
    ...
    enum SourceFlags : quint64 {
        ...
        sf_channel                          = (quint64(1)) << 32,

        sf_by_label                         = (quint64(1)) << 33,
        sf_by_perma                         = (quint64(1)) << 34,
        sf_by_id                            = (quint64(1)) << 35,
        sf_by_title                         = (quint64(1)) << 36,
        sf_by_artist                        = (quint64(1)) << 37,
        sf_by_track                         = (quint64(1)) << 38,
        sf_by_album                         = (quint64(1)) << 39,
        sf_by_compilation                   = (quint64(1)) << 40,
        sf_by_playlist                      = (quint64(1)) << 41,
        sf_by_stream                        = (quint64(1)) << 42,
        sf_by_abc                           = (quint64(1)) << 43,
        sf_by_tag                           = (quint64(1)) << 44,
        sf_by_mood                          = (quint64(1)) << 45,
        sf_by_genre                         = (quint64(1)) << 46,
        sf_by_lyric                         = (quint64(1)) << 47,
        sf_by_user                          = (quint64(1)) << 48,
        sf_by_group                         = (quint64(1)) << 49,
        sf_by_category                      = (quint64(1)) << 50,
        sf_by_like                          = (quint64(1)) << 51,
        sf_by_repost                        = (quint64(1)) << 52,

        sf_section_new                      = (quint64(1)) << 53,
        sf_section_popular                  = (quint64(1)) << 54,
...
//        sf_video_by_me                      = sf_video | sf_by_user | sf_my,
