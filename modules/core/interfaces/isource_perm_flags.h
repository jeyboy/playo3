...
namespace Core {
    ...
    enum SourcePerms : int {
        perm_none                             = 0,
        perm_api                              = 1,
        perm_site                             = (quint64(1)) << 1,

        perm_site_auth_only                   = (quint64(1)) << 2,
        perm_api_auth_only                    = (quint64(1)) << 3,
        perm_prefer                           = (quint64(1)) << 4,

        perm_offline_credentials_req          = (quint64(1)) << 5,
        perm_online_credentials_req           = (quint64(1)) << 6,

        //////////// combinations //////////////////////////

        perm_prefer_site                      = perm_prefer | perm_site,
    };
    ...
    enum SourceFlags : quint64 {
        ...
        sf_is_primary                       = (quint64(1)) << 1,
        sf_is_content_shareable             = (quint64(1)) << 2,
...
//        sf_section_chart                    = (quint64(1)) << 37,
        ...
        sf_videos_recs_by_videos_ids        = sf_video_sets | sf_videos_recs_by_video_id, // recs by a bunch of videos
