        ...
        namespace Od {
            ...
            protected:
                inline SourceFlags defaultFlags() {
                    return (SourceFlags)(
                        sf_primary_source |
                        /*sf_api_auth_has |*/ sf_site_auth_has | sf_site_online_credentials_req |
                        sf_titles_serachable | sf_artists_serachable | sf_albums_serachable | sf_sets_serachable | sf_users_serachable | sf_groups_serachable |
