    ...
    namespace Web {
        namespace Od {
            ...
            protected:
                ...
                inline QString albumAudiosUrl() { return audioUrlStr(path_audio_by_album_id); } // params : (albumId: album id)
                inline QString searchAlbumsUrl(const QString & predicate) { return audioUrlStr(path_audio_search_albums, QUrlQuery(tkn_q_eq % predicate)); } // params : (q: predicate) and pagination attrs
