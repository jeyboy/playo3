...
//            extern const QString tkn_friends           = QStringLiteral("friends");
            ...
            extern const QString query_track_playlists    = QString(
            ...
            extern const QString query_video_playlists    = QString(
                "var curr; var count = 5;"
            ...
            extern const QString query_user_tracks_playlists_groups_friends = QString(
                "var curr; var proceed_groups = [];"
                "var groups = API.groups.get({"
                "            owner_id: %1, "
                "            count: 1000, "
            ...
            extern const QString query_user_tracks_playlists = QString(
                "var folders_result = API.audio.getAlbums({ "
                "            count: " % val_api_call_limit % ", "
                "            owner_id: %1"
                "        });"
