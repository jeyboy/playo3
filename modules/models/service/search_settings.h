...
//    inline SearchRequest(const RequestType & request_type, const QString & subject, int source_type, int content_type, QString predicate = QString(), QString genre = QString())
