...
void Playo::showSearchDialog() {    
    ...
    if (dialog.exec() == QDialog::Accepted) {
        ...
        Dockbars::instance() -> createDocBar(QStringLiteral("Search"), settings, Json::Obj(), true, true, &prms);
    }
}
...
void Playo::openOdTabDialog() {
    if (Od::Api::instance() -> isConnected() || Od::Api::instance() -> connection()) {
        ...
        Dockbars::instance() -> createDocBar(QStringLiteral("OD [YOU]"), settings, Json::Obj(), true, true);
    }
}

void Playo::openVKRecomendations() {
    ViewSettings settings(vk_rel, false, false, false, true, Vk::Api::instance() -> userID(), user_rel);
    Dockbars::instance() -> createDocBar(QStringLiteral("Rec for YOU"), settings, Json::Obj(), true, true);
}
...
void Playo::openVKTabDialog() {
    ...
    if (Plugins::loadWebDialog(dInt)) {
        ...
        if (dialog -> exec() == QDialog::Accepted)
            Dockbars::instance() -> createDocBar(QStringLiteral("VK [YOU]"), ViewSettings::vk(Vk::Api::instance() -> userID()), Json::Obj(), true, true);
...
void Playo::showVKRelTabDialog() {
    ...
    if (dialog.exec() == QDialog::Accepted)
       Dockbars::instance() -> createDocBar(QStringLiteral("VK [") % dialog.getName() % QStringLiteral("]"), ViewSettings::vk(dialog.getId()), Json::Obj(), true, true);
...
void Playo::showSoundcloudRelTabDialog() {
    ...
    if (dialog.exec() == QDialog::Accepted)
        Dockbars::instance() -> createDocBar(QStringLiteral("SC [") % dialog.getName() % QStringLiteral("]"), ViewSettings::soundcloud(dialog.getId()), Json::Obj(), true, true);
...
void Playo::openSoundcloudTabDialog() {
    ...
    if (Plugins::loadWebDialog(dInt)) {
        ...
        if (dialog -> exec() == QDialog::Accepted)
            Dockbars::instance() -> createDocBar(QStringLiteral("SC [YOU]"), ViewSettings::soundcloud(Soundcloud::Api::instance() -> userID()), Json::Obj(), true, true);
